...
class RelayDesktopApp:
    ...
    def build_ui(self) -> None:
        ...
        ttk.Label(import_box, text="导入 api/auth/session", style="Section.TLabel").grid(row=0, column=0, sticky="w")
        ttk.Label(import_box, text="粘贴完整 JSON，导入后会覆盖当前账号。", style="Subtitle.TLabel").grid(row=0, column=1, sticky="e")
